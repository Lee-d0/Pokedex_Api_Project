...
const sort_wrapper = document.querySelector(".sort__wrapper")
...
function handleSortIconOnClick(){
    document.querySelector(".filter__wrapper").classList.toggle("filter__wrapper-open")

    document.querySelector("body").classList.toggle("filter__wrapper-overlay")
}